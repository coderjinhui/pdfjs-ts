...
function renderPageSync(pdfDoc, num, scale, options) {
    return __awaiter(this, void 0, void 0, function () {
        var canvas, ctx, container, page, viewport, renderContext, textLayerDiv;
...
function renderTextSync(page, index, viewport, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!textContent) return [3 /*break*/, 3];
